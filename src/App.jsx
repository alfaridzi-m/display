...
const CityCard = ({ city, temp, conditionIcon: Icon, conditionText, windSpeed, windDirection, theme }) => (
    <div className={`${theme.glassCardClass} p-5 flex flex-col justify-between`}>
        <div className='flex flex-row justify-between w-full items-center'>
            ...
            <div className="flex flex-col items-center">
                <Icon className="w-20 h-20 mr-1.5 text-yellow-500" />
...
const CitiesPage = ({ theme }) => {
    const citiesData = [
        { city: 'Tokyo', country: 'Japan', temp: 29, conditionIcon: CloudSun, conditionText: 'Cloudy', windSpeed: 15, windDirection: 'Timur' },
        { city: 'London', country: 'UK', temp: 18, conditionIcon: CloudRain, conditionText: 'Rainy', windSpeed: 22, windDirection: 'Selatan' },
        { city: 'New York', country: 'USA', temp: 31, conditionIcon: Sun, conditionText: 'Sunny', windSpeed: 8, windDirection: 'Timur' },
        { city: 'Sydney', country: 'Australia', temp: 22, conditionIcon: Cloud, conditionText: 'Overcast', windSpeed: 18, windDirection: 'Utara' },
        { city: 'Sydney', country: 'Australia', temp: 22, conditionIcon: Cloud, conditionText: 'Overcast', windSpeed: 18, windDirection: 'Timur' },
        { city: 'Sydney', country: 'Australia', temp: 22, conditionIcon: Cloud, conditionText: 'Overcast', windSpeed: 18, windDirection: 'Barat' },
        { city: 'Sydney', country: 'Australia', temp: 22, conditionIcon: Cloud, conditionText: 'Overcast', windSpeed: 18, windDirection: 'Timur' },
    ];
    return (
...
const lightTheme = {
  ...
  background: {
    image: "https://img.freepik.com/free-photo/beautiful-tropical-beach-sea-ocean-with-white-cloud-blue-sky-copyspace_74190-8663.jpg?semt=ais_hybrid&w=740",
  },
...
const darkTheme = {
  background: {
    image: "https://images.unsplash.com/photo-1536183922588-166604504d5e?fm=jpg&q=60&w=3000&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8b2NlYW4lMjBuaWdodHxlbnwwfHwwfHx8MA%3D%3D",
  },
...
export default function App() {
  ...
  return (
    <>
      ...
      <div 
        className={`min-h-screen flex flex-col md:flex-row font-sans relative overflow-hidden bg-cover bg-center ${isDarkMode ? 'dark' : theme.gradient}`}
        style={{ backgroundImage: isDarkMode ? `url(${theme.background.image})` : `url(${theme.background.image})` }}
      >
